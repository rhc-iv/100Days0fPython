...
PROMISED_DOWN = 300
PROMISED_UP = 10
TWITTER_EMAIL: "rhc.iv@icloud.com"
TWITTER_PASSWORD: "^5*mf%CQDox6U$H^aqG8H#TpTdf747mp"
...
class InternetSpeedTwitterBot:
    ...
    def get_internet_Speed(self):
        ...
        sleep(4)
        accept_cookie = self.driver.find_element(By.CLASS_NAME,
                                                 value="onetrust-banner-options")
        accept_cookie.click()
        sleep(5)
    ...
    def tweet_at_provider(self):
        ...
        try:
            ...
            username.send_keys("example")  # Your Username here in case
            # Twitter asks for username before asking password
        ...
        input = self.driver.find_element(By.CSS_SELECTOR,
                                         'br[data-text="true"]')
        input.send_keys(
            f"My Current Internet Speed is {self.down} Download and "
            f"{self.up} Upload")
        sleep(3)
        tweet = self.driver.find_element(By.XPATH,
                                         "//*[@id='react-root']/div/div/div["
                                         "2]/main/div/div/div/div["
                                         "1]/div/div[3]/div/div[2]/div["
