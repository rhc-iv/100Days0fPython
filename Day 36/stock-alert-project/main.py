...
VIRTUAL_TWILIO_NUMBER = "+17207072233"
VERIFIED_NUMBER = "+15042501250"
...
STOCK_API_KEY = "SHIKLDVPZCJLRRC8"
NEWS_API_KEY = "e47ad810ed1c4132901c5c3a74a3c224"
...
day_before_yesterday_closing_price = day_before_yesterday_data[
    "4. close"]
print(day_before_yesterday_closing_price)

# Find the positive difference between 1 and 2. e.g. 40 - 20 = -20,
# but the positive difference is 20. Hint:
...
# STEP 2: Instead of printing ("Get News"), actually get the first 3
# news pieces for the COMPANY_NAME.

# Instead of printing ("Get News"), use the News API to get articles
...
if abs(diff_percent) > 1:
    ...
    # Use Python slice operator to create a list that contains the
    # first 3 articles. Hint:
    # https://stackoverflow.com/questions/509211/understanding-slice
    # -notation

    three_articles = articles[:3]
    print(three_articles)

    # STEP 3: Use Twilio to send a separate message with each
    # article's title and description to your phone number.

    # Create a new list of the first 3 article's headline and
